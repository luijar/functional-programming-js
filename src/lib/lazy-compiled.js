...
!(function (context) {
  function Lazy(e) {
    if (e instanceof Array) return new ArrayWrapper(e);if ("string" == typeof e) return new StringWrapper(e);if (e instanceof Sequence) return e;if (Lazy.extensions) {
      for (var t, n = Lazy.extensions, r = n.length; !t && r--;) t = n[r](e);if (t) return t;
    }return new ObjectWrapper(e);
  }function Sequence() {}function Iterator(e) {
  ...
  }function ArrayLikeSequence() {}function IndexedIterator(e) {
    this.sequence = e, this.index = -1;
    ...
    this.parent = e, this.other = t;
  }function ObjectLikeSequence() {}function FilteredObjectLikeSequence(e, t) {
    this.parent = e, this.filterFn = t;
    ...
    if ("undefined" == typeof t) return e;if ("object" != typeof e || null === e || "object" != typeof t || null === t) return t;var n,
        r = {};for (n in e) r[n] = mergeObjects(e[n], t[n]);for (n in t) r[n] || (r[n] = t[n]);return r;
    ...
    this.source = e;
  }function StringLikeSequence() {}function CharIterator(e) {
    ...
    if (e instanceof AsyncSequence) throw new Error("Sequence is already asynchronous!");this.parent = e, this.interval = t, this.onNextCallback = getOnNextCallback(t), this.cancelCallback = getCancelCallback(t);
  }function AsyncHandle(e) {
    this.resolveListeners = [], this.rejectListeners = [], this.state = PENDING, this.cancelFn = e;
  }function resolve(e, t) {
    if (e === t) return void e._reject(new TypeError("Cannot resolve a promise to itself"));if (t instanceof AsyncHandle) return void t.then(function (t) {
      resolve(e, t);
    }, function (t) {
      e._reject(t);
    });var n;try {
    ...
    }var i = PENDING;if ("function" != typeof n) e._resolve(t);else try {
      n.call(t, function (t) {
      ...
      if (i !== PENDING) return;e._reject(r);
    }
    ...
    this.listeners = [], t ? t instanceof Array || (t = [t]) : t = Lazy(e).keys().toArray();var n = this.listeners,
        r = 0;Lazy(t).each(function (t) {
      var i = e[t];Object.defineProperty(e, t, { get: function get() {
          return i;
        }, set: function set(e) {
          for (var o = n.length - 1; o >= 0; --o) n[o]({ property: t, value: e }, r) === !1 && n.splice(o, 1);i = e, ++r;
        } });
    });
  }function StreamLikeSequence() {}function SplitStreamSequence(e, t) {
    ...
    var t = new Set();return (Lazy(e || []).flatten().each(function (e) {
      t.add(e);
    }), t);
  }function compare(e, t) {
    return e === t ? 0 : e > t ? 1 : -1;
  }function forEach(e, t) {
    for (var n = -1, r = e.length; ++n < r;) if (t(e[n], n) === !1) return !1;return !0;
  }function getFirst(e) {
    var t;return (e.each(function (e) {
      return (t = e, !1);
    }), t);
  }function arrayContains(e, t) {
    var n = -1,
        r = e.length;if (t !== t) {
      for (; ++n < r;) if (e[n] !== e[n]) return !0;return !1;
    }for (; ++n < r;) if (e[n] === t) return !0;return !1;
  }function arrayContainsBefore(e, t, n, r) {
    var i = -1;if (r) {
      for (r = createCallback(r); ++i < n;) if (r(e[i]) === r(t)) return !0;
    } else for (; ++i < n;) if (e[i] === t) return !0;return !1;
  }function swap(e, t, n) {
    ...
    var r = function r() {};r.prototype = new e();for (var i in n) r.prototype[i] = n[i];for (var o = function o() {
      var e = new r();return (e.parent = this, e.init && e.init.apply(e, arguments), e);
    }, u = "string" == typeof t ? [t] : t, c = 0; c < u.length; ++c) e.prototype[u[c]] = o;return r;
  }Lazy.VERSION = "0.4.0", Lazy.noop = function () {}, Lazy.identity = function (e) {
    return e;
  }, Lazy.strict = function () {
    function e(e) {
      if (null == e) throw new Error("You cannot wrap null or undefined using Lazy.");if ("number" == typeof e || "boolean" == typeof e) throw new Error("You cannot wrap primitive values using Lazy.");return Lazy(e);
    }return (Lazy(Lazy).each(function (t, n) {
      e[n] = t;
    }), e);
  }, Sequence.define = function (e, t) {
    if (!t || !t.getIterator && !t.each) throw new Error("A custom sequence must implement *at least* getIterator or each!");return defineSequenceType(Sequence, e, t);
    ...
    var e = this.cachedIndex;return (e || (e = this.cachedIndex = this.sequence.getIndex()), this.index >= e.length() - 1 ? !1 : (++this.index, !0));
    ...
    var t;return (this.each(function (n, r) {
    ...
    for (var t = this.getIterator(), n = -1; t.moveNext();) if (e(t.current(), ++n) === !1) return !1;return !0;
    ...
    var t = this.mapFn;return this.parent.each(function (n, r) {
      return e(t(n, r), r);
    });
    ...
    var t = this.filterFn,
        n = 0;return this.parent.each(function (r, i) {
    ...
    for (var e, t = this.iterator, n = this.filterFn; t.moveNext();) if ((e = t.current(), n(e, this.index++))) return (this.value = e, !0);return (this.value = void 0, !1);
    ...
    var e = this.getIndex(),
        t = e.length();return ("undefined" == typeof this.index && (this.index = t), --this.index >= 0);
    ...
    var t = !1,
        n = 0;this.parent.each(function (r) {
    ...
    var t = this.count,
      ...
      var i;return (t > n && (i = e(r, n++)), n >= t ? !1 : i);
    ...
    var t = this.parent.getIndex();return t.take(t.length() - this.count).each(e);
    ...
    var t = this.count,
        n = 0,
        r = 0;return this.parent.each(function (i) {
    ...
    var t = this.predicate,
        n = !1;return this.parent.each(function (r) {
      if (!n) {
        if (t(r)) return;n = !0;
      }return e(r);
    });
    ...
    var t = this.sortFn,
        n = this.parent.toArray();return (n.sort(t), forEach(n, e));
    ...
    var t = new Set(),
        n = this.keyFn,
        r = 0;return n ? (n = createCallback(n), this.parent.each(function (i) {
    ...
    var t = this.arrays,
        n = 0;this.parent.each(function (r) {
      for (var i = [r], o = 0; o < t.length; ++o) t[o].length > n && i.push(t[o][n]);return e(i, n++);
    });
    ...
    for (var t = this.parent.toArray(), n = Math.floor, r = Math.random, i = 0, o = t.length - 1; o > 0; --o) if ((swap(t, o, n(r() * o)), e(t[o], i++) === !1)) return;e(t[0], i);
    ...
    var t = 0;return this.parent.each(function n(r) {
    ...
    var t = createSet(this.values),
        n = 0;return this.parent.each(function (r) {
    ...
    var t = Lazy(this.arrays).map(function (e) {
      return new UniqueMemoizer(Lazy(e).getIterator());
        ...
        r = 0;return this.parent.each(function (t) {
      var i = !0;return (n.each(function (e) {
    ...
    for (var e, t = this.iterator, n = this.set, r = this.memo; t.moveNext();) if ((e = t.current(), n.add(e))) return (r.push(e), this.currentValue = e, !0);return !1;
  }, UniqueMemoizer.prototype.each = function (e) {
    for (var t = this.memo, n = t.length, r = -1; ++r < n;) if (e(t[r], r) === !1) return !1;for (; this.moveNext() && e(this.currentValue, r++) !== !1;);
  }, UniqueMemoizer.prototype.contains = function (e) {
    if (this.set.contains(e)) return !0;for (; this.moveNext();) if (this.currentValue === e) return !0;return !1;
    ...
    e = createCallback(e, !0);var t = !1;return (this.each(function (n) {
    ...
    var t = -1;return (this.each(function (n, r) {
      return n === e ? (t = r, !1) : void 0;
    }), t);
  }, Sequence.prototype.lastIndexOf = function (e) {
    var t = this.getIndex().reverse(),
        n = t.indexOf(e);return (-1 !== n && (n = t.length() - n - 1), n);
  }, Sequence.prototype.sortedIndex = function (e) {
    for (var t, n = this.getIndex(), r = 0, i = n.length(); i > r;) t = r + i >>> 1, -1 === compare(n.get(t), e) ? r = t + 1 : i = t;return r;
  }, Sequence.prototype.contains = function (e) {
    return -1 !== this.indexOf(e);
  }, Sequence.prototype.reduce = function (e, t) {
    if (arguments.length < 2) return this.tail().reduce(e, this.head());var n = this.each(function (n, r) {
      t = e(t, n, r);
    ...
    if (arguments.length < 2) return this.initial(1).reduceRight(e, this.last());var n = this.getIndex(),
        r = n.length() - 1;return n.reverse().reduce(function (t, n) {
      return e(t, n, r--);
    }, t);
    ...
    if (1 > e) throw new Error("You must specify a positive chunk size.");return new ChunkedSequence(this, e);
    ...
    for (var e = this.iterator, t = this.size, n = []; n.length < t && e.moveNext();) n.push(e.current());return 0 === n.length ? !1 : (this.currentChunk = n, !0);
    ...
    var t = this.callback;return this.parent.each(function (n, r) {
      return (t(n, r), e(n, r));
    });
    ...
    var t = this.array;return this.parent.each(function (n, r) {
      return e([n, t[r]], r);
    });
  }, ArrayLikeSequence.prototype = new Sequence(), ArrayLikeSequence.define = function (e, t) {
    if (!t || "function" != typeof t.get) throw new Error("A custom array-like sequence must implement *at least* get!");return defineSequenceType(ArrayLikeSequence, e, t);
    ...
    for (var t = this.length(), n = -1; ++n < t;) if (e(this.get(n), n) === !1) return !1;return !0;
    ...
    var n = this.length();0 > e && (e = n + e);var r = this.drop(e);return ("number" == typeof t && (0 > t && (t = n + t), r = r.take(t - e)), r);
    ...
    for (var t, n = this.parent, r = this.filterFn, i = this.parent.length(), o = -1, u = 0; ++o < i;) if ((t = n.get(o), r(t, o) && e(t, u++) === !1)) return !1;return !0;
    ...
    var e = this.parent.length();return this.count <= e ? this.count : e;
    ...
    var e = this.parent.length();return this.count <= e ? e - this.count : 0;
    ...
    var t = this.parent.length();return t > e ? this.parent.get(e) : this.other[e - t];
    ...
    for (var t, n, r = this.parent, i = this.keyFn, o = r.length(), u = [], c = arrayContains, a = -1, p = 0; ++a < o;) if ((n = r.get(a), t = i(n), !c(u, t) && (u.push(t), e(n, p++) === !1))) return !1;
    ...
    var t = this.parent.source;return 0 > e || e >= t.length ? void 0 : this.mapFn(t[e]);
  }, MappedArrayWrapper.prototype.length = function () {
    return this.parent.source.length;
  }, MappedArrayWrapper.prototype.each = function (e) {
    for (var t = this.parent.source, n = t.length, r = this.mapFn, i = -1; ++i < n;) if (e(r(t[i], i), i) === !1) return !1;return !0;
  }, FilteredArrayWrapper.prototype = new FilteredSequence(), FilteredArrayWrapper.prototype.each = function (e) {
    for (var t, n = this.parent.source, r = this.filterFn, i = n.length, o = -1, u = 0; ++o < i;) if ((t = n[o], r(t, o) && e(t, u++) === !1)) return !1;return !0;
  }, UniqueArrayWrapper.prototype = new Sequence(), UniqueArrayWrapper.prototype.eachNoCache = function (e) {
    for (var t, n = this.parent.source, r = this.keyFn, i = n.length, o = arrayContainsBefore, u = -1, c = 0; ++u < i;) if ((t = n[u], !o(n, t, u, r) && e(t, c++) === !1)) return !1;return !0;
  }, UniqueArrayWrapper.prototype.eachArrayCache = function (e) {
    var t,
        n,
        r = this.parent.source,
        i = this.keyFn,
        o = r.length,
        u = [],
        c = arrayContains,
        a = -1,
        p = 0;if (i) {
      for (i = createCallback(i); ++a < o;) if ((n = r[a], t = i(n), !c(u, t) && (u.push(t), e(n, p++) === !1))) return !1;
    } else for (; ++a < o;) if ((n = r[a], !c(u, n) && (u.push(n), e(n, p++) === !1))) return !1;return !0;
    ...
    var t = this.parent.source,
        n = t.length;return n > e ? t[e] : this.other[e - n];
    ...
    for (var t = this.parent.source, n = t.length, r = this.other, i = r.length, o = 0, u = -1; ++u < n;) if (e(t[u], o++) === !1) return !1;for (u = -1; ++u < i;) if (e(r[u], o++) === !1) return !1;return !0;
  }, ObjectLikeSequence.prototype = new Sequence(), ObjectLikeSequence.define = function (e, t) {
    if (!t || "function" != typeof t.each) throw new Error("A custom object-like sequence must implement *at least* each!");return defineSequenceType(ObjectLikeSequence, e, t);
    ...
    var t = this.filterFn;return this.parent.each(function (n, r) {
    ...
    var t = new Set(),
        n = !1;return (Lazy(this.other).each(function (r, i) {
    ...
    var t = new Set(),
        n = !1;this.parent.each(function (r, i) {
    ...
    var e = arguments.length > 1 && "function" == typeof arguments[arguments.length - 1] ? arrayPop.call(arguments) : null;return new MergedSequence(this, arraySlice.call(arguments, 0), e);
  }, MergedSequence.prototype = new ObjectLikeSequence(), MergedSequence.prototype.each = function (e) {
    var t = this.others,
        n = this.mergeFn || mergeObjects,
        r = {},
        i = this.parent.each(function (i, o) {
      var u = i;return (forEach(t, function (e) {
        o in e && (u = n(u, e[o]));
      }), r[o] = !0, e(u, o));
    });if (i === !1) return !1;var o = {};return (forEach(t, function (e) {
    ...
    var t = arrayContains,
        n = this.properties;return this.parent.each(function (r, i) {
    ...
    var t,
        n = createCallback(this.keyFn);return (t = this.parent.reduce(function (e, t) {
      var r = n(t);return (e[r] instanceof Array ? e[r].push(t) : e[r] = [t], e);
    }, {}), transform(function (t) {
      for (var n in t) if (e(t[n], n) === !1) return !1;
    }, t));
    ...
    var t = createCallback(this.keyFn),
        n = {};return this.parent.each(function (r) {
      var i = t(r);return n[i] ? void 0 : (n[i] = r, e(r, i));
    });
  }, CountedSequence.prototype = new ObjectLikeSequence(), CountedSequence.prototype.each = function (e) {
    var t = createCallback(this.keyFn),
        n = {};this.parent.each(function (e) {
      var r = t(e);n[r] ? n[r] += 1 : n[r] = 1;
    });for (var r in n) if (e(n[r], r) === !1) return !1;return !0;
    ...
    var t,
        n = this.source;for (t in n) if (e(n[t], t) === !1) return !1;return !0;
  }, StringLikeSequence.prototype = new ArrayLikeSequence(), StringLikeSequence.define = function (e, t) {
    if (!t || "function" != typeof t.get) throw new Error("A custom string-like sequence must implement *at least* get!");return defineSequenceType(StringLikeSequence, e, t);
    ...
    var t = this.charAt(e);return t ? t.charCodeAt(0) : 0 / 0;
    ...
    if (!this.pattern) return !1;var e = this.pattern.exec(this.source);return e ? (this.start = this.nextStart ? this.nextStart : 0, this.end = e.index, this.nextStart = e.index + e[0].length, !0) : this.pattern ? (this.start = this.nextStart, this.end = void 0, this.nextStart = void 0, this.pattern = void 0, !0) : !1;
    ...
    for (var t = this.get, n = this.fixedLength, r = 0; "undefined" == typeof n || n > r;) if (e(t(r), r++) === !1) return !1;return !0;
    ...
    var e = this.sequence;return "number" == typeof e.fixedLength && this.index >= e.fixedLength ? !1 : (this.currentValue = e.get(this.index++), !0);
    ...
    var t = this.parent.getIterator(),
      ...
      RESOLVED = 2,
      REJECTED = 3;AsyncHandle.prototype.then = function (e, t) {
    var n = new AsyncHandle(this.cancelFn);return (this.resolveListeners.push(function (t) {
      try {
        if ("function" != typeof e) return void resolve(n, t);resolve(n, e(t));
      } catch (r) {
        n._reject(r);
      }
    }), this.rejectListeners.push(function (e) {
      try {
        if ("function" != typeof t) return void n._reject(e);resolve(n, t(e));
      } catch (r) {
        n._reject(r);
      }
    ...
    var t,
        n = cloneRegex(this.delimiter),
        r = "",
        i = 0,
        o = 0,
        u = this.parent.each(function (u) {
      r += u;for (var c; c = n.exec(r);) {
        if ((t = c.index, e(r.substring(i, t), o++) === !1)) return !1;i = t + c[0].length;
      }r = r.substring(i), i = 0;
    ...
    var t = this.delimiter,
      ...
      r += i;for (var o; (o = r.indexOf(t)) >= 0;) {
        var u = r.substr(0, o);if ((r = r.substr(o + t.length), e(u, n++) === !1)) return !1;
      }return !0;
    ...
    var t = function t() {
      ...
      var n = new t();return (e.apply(n, arguments), n);
    });
    ...
    var e = arguments.length > 1 ? arguments[0] : 0,
        ...
        n = arguments.length > 2 && arguments[2];return (n === !1 && (n = t > e ? 1 : -1), 0 === n ? Lazy([]) : Lazy.generate(function (t) {
      return e + n * t;
    ...
    return function () {
      ...
      arraySlice = Array.prototype.slice;Set.prototype.add = function (e) {
    var t,
        n = this.table,
        r = typeof e;switch (r) {case "number":case "boolean":case "undefined":
        return n[e] ? !1 : (n[e] = !0, !0);case "string":
        switch (e.charAt(0)) {case "_":case "f":case "t":case "c":case "u":case "@":case "0":case "1":case "2":case "3":case "4":case "5":case "6":case "7":case "8":case "9":case "N":
            e = "@" + e;}return n[e] ? !1 : (n[e] = !0, !0);default:
        return (t = this.objects, arrayContains(t, e) ? !1 : (t.push(e), !0));}
  }, Set.prototype.contains = function (e) {
    var t = typeof e;switch (t) {case "number":case "boolean":case "undefined":
        return !!this.table[e];case "string":
        switch (e.charAt(0)) {case "_":case "f":case "t":case "c":case "u":case "@":case "0":case "1":case "2":case "3":case "4":case "5":case "6":case "7":case "8":case "9":case "N":
            e = "@" + e;}return !!this.table[e];default:
        return arrayContains(this.objects, e);}
  }, Queue.prototype.add = function (e) {
    var t = this.contents,
        n = t.length,
        r = this.start;return (this.count === n ? (t[r] = e, this.start = (r + 1) % n) : t[this.count++] = e, this);
  }, Queue.prototype.toArray = function () {
    var e = this.contents,
        t = this.start,
        n = this.count,
        r = e.slice(t, t + n);return (r.length < n && (r = r.concat(e.slice(0, n - r.length))), r);
